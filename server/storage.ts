...
export interface IStorage {
  ...
  // Product operations
  getProducts(filters?: { country?: string; material?: string; search?: string }): Promise<Product[]>;
...
export class MemStorage implements IStorage {
    ...
    const sampleProducts: InsertProduct[] = [
      {
        ...
        description: "Hand-carved from sustainable teak wood by skilled artisans in Kerala, India. Each bowl is unique with its own grain pattern and natural beauty.",
      ...
      },
      {
        ...
        description: "Soft alpaca wool with traditional patterns, handwoven by Peruvian artisans using ancestral techniques.",
      ...
      },
      {
        ...
        description: "Traditional blue pottery with intricate details, handcrafted in Fez using centuries-old techniques.",
      ...
      },
      {
        ...
        description: "Hand-forged sterling silver with natural stones, crafted by Thai silversmiths.",
      ...
      },
      {
        ...
        description: "Hand-stitched with traditional Mayan patterns, made from premium leather.",
      ...
      },
      {
        ...
        description: "Eco-friendly woven bamboo with natural finish, perfect for storage.",
  ...
  // Product operations
  async getProducts(filters?: { country?: string; material?: string; search?: string }): Promise<Product[]> {
    let products = Array.from(this.products.values());

    if (filters?.country) {
      products = products.filter(p => p.countryOfOrigin.toLowerCase() === filters.country!.toLowerCase());
    }
  ...
  async updateOrderStatus(orderId: string, status: string, trackingNumber?: string): Promise<Order | undefined> {
    const order = this.orders.get(orderId);
    if (order) {
      const updatedOrder = { ...order, status, trackingNumber: trackingNumber || order.trackingNumber };
