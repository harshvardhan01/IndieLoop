				...
				<div className="bg-white p-8 rounded-lg shadow-md">
					...
					<div className="prose prose-lg text-gray-700 max-w-none">
						...
						<section className="mb-8">
							...
							<ul className="list-disc pl-6 mb-4 space-y-2">
								<li>
									To trusted third parties who assist us in
									operating our website and conducting
									business
								</li>
								<li>
									When we believe release is appropriate to
									comply with the law
								</li>
								<li>
									To enforce our site policies or protect our
									rights and safety
								</li>
							</ul>
						</section>
						...
						<section className="mb-8">
							...
							<p className="mb-4">
								...
								analyze site usage, and assist in our marketing
								efforts. You can choose to disable cookies
